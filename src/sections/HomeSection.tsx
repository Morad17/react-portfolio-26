...
const HomeSection = ({
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    if (isMobile || !isHoveredRef.current) return;
    const rect = imageRef.current?.getBoundingClientRect();
    if (!rect) return;
    const x = e.clientX - rect.left;
    const y = e.clientY - rect.top;
  ...
  // Always call hooks — rules of hooks require unconditional calls
  ...
  if (isMobile) {
    return (
      <section className="panel home-panel" aria-label="Home">
        <div className={`home-inner mob-animate ${isActive ? "mob-visible" : ""}`}>
          <div className="home-content">
            ...
            <div className="home-lines">
              {textLines.map((line) => (
                <div key={line.id} className="home-line-wrap">
                  <span className="home-bar" />
                  <h3 className="home-line-text">
                    {line.parts.map((part, i) =>
                      typeof part === "string" ? (
                        ...
                        <span key={i} className="home-line-highlight">
                          {part.text}
                        </span>
                      ),
                    )}
          ...
          <div className="home-portrait">
            <div className="home-portrait-circle" ref={imageRef}>
              <img src={smartPhoto} alt="Morad Elb" className="home-portrait-img" />
            </div>
          </div>
        </div>
      </section>
